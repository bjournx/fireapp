...
class FirefighterList(ListView):
    model = Firefighters
    context_object_name = 'fire_fighter'
    template_name = "fire_fighter_list.html"
    paginate_by = 5
